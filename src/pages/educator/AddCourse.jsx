...
const AddCourse = () => {
  ...
  const [lectureDetails, setLectureDetails] = useState({
    ...
    lectureUrl: "",
    isPreviewFree: false,
    quiz: { isEnabled: false, questions: [] },
  });
  ...
  const addQuizQuestion = () => {
    ...
    setLectureDetails({
      ...
      quiz: {
        ...lectureDetails.quiz,
        questions: [...lectureDetails.quiz.questions, newQuestion],
      },
    });
  };

  const removeQuizQuestion = (qIndex) => {
    const updatedQuestions = lectureDetails.quiz.questions.filter(
  ...
  const updateQuizQuestion = (qIndex, field, value) => {
    const updatedQuestions = [...lectureDetails.quiz.questions];
              ...
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80 max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex gap-2 my-4">
                  ...
                  <input
                    type="checkbox"
                    className="mt-1 scale-125"
                    checked={lectureDetails.quiz.isEnabled}
                    onChange={(e) =>
                      handleQuizChange("isEnabled", e.target.checked)
                    }
                  />
                </div>

                {lectureDetails.quiz.isEnabled && (
                  <div className="mt-4 border-t pt-4">
                    <h3 className="font-semibold mb-2">Quiz Questions</h3>
                    {lectureDetails.quiz.questions.map((question, qIndex) => (
                      <div
                        key={qIndex}
                        className="mb-4 border p-2 rounded bg-gray-50"
                      >
                ...
                <button
                  type="button"
                  className="w-full bg-blue-400 text-white px-4 py-2 rounded mt-4"
                  onClick={addLecture}
                >
                  Add
                </button>
